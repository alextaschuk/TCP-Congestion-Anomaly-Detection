...
/**
 * @brief An application would call this function to send data.
 * 
 * This function writes `payload_len` number of bytes, or the maximum
 * number available, to a `tx_buffer`, then calls `tcp_output()` to send
 * the packet.
 * 
 ...
 * 
 * @returns The number of bytes sent (i.e., written to `tx_buf`)
 */
