...
typedef struct tcb_t
{
    ...
    const struct cc_ops_t *cc;  /* The congestion control handler. */
    enum ca_state ca_state;     /* The current congestion avoidance state. */
    ...
    /* Internal TCB control flags necessary for forcing certain actions. */
    uint16_t t_flags;
